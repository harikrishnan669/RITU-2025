                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex gap-5 items-center justify-center flex-wrap px-10">
                                    <a href="tel:+919074486344"
                                       className="max-lg:flex-1 items-center justify-center  gap-3 flex border rounded-lg  cursor-pointer bg-gray-900/50 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300 text-lg px-8 max-md:mx-10 py-4 border-gray-600 text-gray-200 hover:text-white mt-3"
                                       >
                                        <Phone /> +919074486344
                                    </a>
                                    <a href="https://wa.me/919074486344"
                                       className="max-lg:flex-1 items-center justify-center  gap-3 flex border rounded-lg  cursor-pointer bg-gray-900/50 backdrop-blur-sm hover:bg-gray-800/70 transition-all duration-300 text-lg px-8 max-md:mx-10 py-4 border-gray-600 text-gray-200 hover:text-white mt-3"
                                    >
