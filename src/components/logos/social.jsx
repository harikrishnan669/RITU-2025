export function Instagram({width = '24px', height = '24px'}) {
    return <svg fill="#ffffff" version="1.1" xmlns="http://www.w3.org/2000/svg"
                width={width} height={height}
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 260 260" enableBackground="new 0 0 260 260"
                xml:space="preserve">
        <g strokeWidth="0"></g>
