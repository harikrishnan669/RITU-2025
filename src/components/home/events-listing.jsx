...
export default function EventsListing() {
    ...
    return <section className="container-cont">
        ...
        <div
            ...
            <div className="w-full flex flex-col justify-center items-start gap-12 max-sm:gap-10">
                <Link href={'/workshop'}
                    ...
                    z-20 px-20 py-7 max-sm:py-6 rounded-md min-w-[30vw] flex items-center justify-center cursor-pointer select-none max-sm:max-w-[60vw] max-sm:min-w-[60vw] max-sm:px-5"
