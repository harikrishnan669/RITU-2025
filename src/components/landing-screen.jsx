...
export default function LandingScreen() {
    return (
        <main className="relative flex items-center justify-center h-screen text-white px-20">

            <div className="size-full flex flex-col justify-center">
                <div className="pt-10 flex items-end justify-end space-y-4 text-4xl flex-col">
                ...
                <div
                    className="h-fit p-0 text-[15vw]/[1] flex justify-between font-bold text-center blur-lg"
                >
            ...
            <img src="/ritu-ballon.png" className="absolute w-[40%]"/>
        </main>
    );
}